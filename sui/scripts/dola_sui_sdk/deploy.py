...
wormhole_package = sui_brownie.SuiPackage(
    ...
    package_path=Path.home().joinpath(Path(
        ".move/https___github_com_OmniBTC_wormhole_git_8c76962c8144ff8c83950fbfbfb14699b424f6d7/sui/wormhole")),
)
...
lending_package = sui_brownie.SuiPackage(
    ...
    is_compile=False,
    package_id=None,
    package_path=DOLA_CONFIG["DOLA_SUI_PATH"].joinpath("omnicore/lending_core")
)
...
genesis_proposal_package = sui_brownie.SuiPackage(
    ...
    package_path=DOLA_CONFIG["DOLA_SUI_PATH"].joinpath(
        "omnicore/proposals/genesis_proposal")
)
...
print(f"lending_core={lending_package.package_id}")
