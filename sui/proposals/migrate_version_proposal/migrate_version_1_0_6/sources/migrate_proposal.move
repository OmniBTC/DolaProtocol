module migrate_version_proposal::proposal {
    ...
    use dola_protocol::genesis::{Self, GovernanceGenesis, Version_1_0_6, Version_1_0_7};
    ...
    public entry fun add_description_for_proposal(
        ...
        let description: String = ascii::string(b"Migrate version from v_1_0_6 to v_1_0_7");
    ...
    public entry fun vote_porposal(
        ...
        if (option::is_some(&governance_cap)) {
            ...
            let new_version = genesis::get_version_1_0_7();
            genesis::migrate_version<Version_1_0_6, Version_1_0_7>(&cap, gov_genesis, new_version);
