module migrate_version_proposal::migrate_proposal {
    ...
    use dola_protocol::genesis::{Self, GovernanceGenesis, Version_1_0_4, Version_1_0_5};
    ...
    public fun migrate_version(
        ...
        let new_version = genesis::get_version_1_0_5();
        genesis::migrate_version<Version_1_0_4, Version_1_0_5>(&cap, gov_genesis, new_version);
