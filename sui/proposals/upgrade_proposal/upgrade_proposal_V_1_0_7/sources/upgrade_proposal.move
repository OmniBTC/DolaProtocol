module upgrade_proposal::proposal {
    ...
    const DIGEST: vector<u8> = x"a642a3a003697213ff53e3dffcb747cc0be72018c8613d4cb378371c1568a165";
    const POLICY: u8 = 0;
    ...
    public entry fun add_description_for_proposal(
        ...
        let description: String = ascii::string(b"Upgrade version from v_1_0_6 to v_1_0_7");
