module lending::lending {
    ...
    use serde::serde::{serialize_u64, deserialize_u64};
    ...
    public entry fun encode_app_payload(amount: u64): vector<u8> {
        let payload = vector::empty<u8>();
        serialize_u64(&mut payload, amount);
        payload
    }

    public entry fun decode_app_payload(app_payload: vector<u8>): u64 {
