module governance_actions::governance_actions {
    ...
    use governance::governance_v1::{Self, Governance, VoteExternalCap};
    ...
    public entry fun vote_init_bridge_cap(
        ...
        let governance_cap = governance_v1::vote_external_cap(gov, vote, ctx);

        if (option::is_some(&governance_cap)) {
            let governance_cap = governance_v1::borrow_external_cap(&mut governance_cap);
        ...
        governance_v1::external_cap_destroy(vote, governance_cap);
    }
